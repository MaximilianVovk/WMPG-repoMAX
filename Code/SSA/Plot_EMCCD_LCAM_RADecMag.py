...
def interp_data_min(offset, df_source, df_ephemeris):
    ...
    if len(ephemeris_times_limited) < 4 or len(closest_indices) < 4:
        # raise an error if there are not enough points for cubic interpolation
        raise ValueError("Not enough points for cubic interpolation, add more data points and re run the code")
...
if __name__ == "__main__":
    ...
    # input_dir_EMCCD=r'C:\Users\maxiv\Documents\UWO\Space Situational Awareness DRDC\25mm\20240713\CAEUA3-CRYOSTAT2_052704.55\2024-07-13T05_27_14_RMS_detection_CAEUA3_auto.ecsv'
    # EMCCD_name = 'FTPdetectinfo_file'
