...
from wmpl.MetSim.ML.GenerateSimulations_precise import generateErosionSim,saveProcessedList,MetParam
...
if __name__ == "__main__":
    ...
    # consider also the ammount of time passed to breake the while loop
    import time
    timeout = 30  # Maximum time in seconds
    start_time = time.time()
    while nsim_results < cml_args.nsims/3:
        # print("---- erosion_sim_params: ", erosion_sim_params.__dict__.keys())
        ...
        print('cureent good results:', nsim_results)
    ...
    fig.savefig(cml_args.output_dir+r'\GeratedSIM_'+name_file+'.png', dpi=300)
    plt.close(fig)
    # plt.show()