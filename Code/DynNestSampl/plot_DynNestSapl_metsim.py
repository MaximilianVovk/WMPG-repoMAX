...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('--input_dir', metavar='INPUT_PATH', type=str,
        default=r"C:\Users\maxiv\Documents\UWO\Papers\0.3)Phaethon\Results\GEM-test\Nick-EMCCD\20211214_090300_combined+EMCCD",
    ...
    setup_folder_and_run_dynesty(cml_args.input_dir, 
