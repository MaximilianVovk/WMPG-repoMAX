...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('--input_dir', metavar='INPUT_PATH', type=str,
        default=r"C:\Users\maxiv\Documents\UWO\Papers\0.4)Wake\Jessica_flare\20251001_060203_output_magbump\20251001_060203_test_add_wake", 
    ...
    setupDirAndRunDynesty(cml_args.input_dir, 
        ...
        only_plot=True)#, priorFile_to_update_with_posteriors=r"C:\Users\maxiv\Documents\UWO\Papers\0.4)Wake\stony_meteoroid_wake_update-fix.prior")
