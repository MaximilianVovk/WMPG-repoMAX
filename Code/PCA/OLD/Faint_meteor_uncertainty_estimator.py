...
SAVE_SELECTION_FOLDER='PCA_Selection'
VAR_SEL_DIR_SUFX = '_sel_var_vs_physProp'
PCA_SEL_DIR_SUFX = '_sel_PCA_vs_physProp'

SAVE_PRELIMINARY_RESULTS = 'Preliminary_Results'
SAVE_RESULTS_FOLDER_EVENTS_PLOTS = 'Preliminary_Results'+os.sep+'events_plots'
