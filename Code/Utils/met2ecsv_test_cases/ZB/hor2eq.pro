...
co_nutate, jd[0], 45.0,45.0, dra1, ddec1, eps=eps, d_psi=d_psi
...
co_nutate, jd[0], ra, dec, dra1, ddec1, eps=eps, d_psi=d_psi
co_aberration, jd[0], ra, dec, dra2, ddec2, eps=eps
