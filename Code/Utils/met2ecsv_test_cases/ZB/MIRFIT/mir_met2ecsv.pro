pro mir_met2ecsv,hp,vp,cam,dir
...
stop
read_mirfit_state_file_data,meteor0,dir,stfl,seq,time,ts0,mir_site1,mir_site2

mir_site1.offset=offset1
mir_site2.offset=offset2
...
iunit=2
;cam='02'+stream
event=strmid(mir_site2.event,1,23)
...
mag1= meteor0[ind1[i]].lsp+mir_site1.offset
...
mag2= meteor0[ind2[i]].lsp+mir_site2.offset
;stop
